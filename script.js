...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        case "intro":
            setTimeout(() => {
                sendTextMessage("Здравствуйте товарищи,<br><br>Моё имя <span class='bold'><a class='alink'>Королевский Ад</a>.</span><br><br>Я частенько провожу трансляции, тоесть <span class='bold'>стример... 🫥</span><br><br>I am eager to hear about potential career opportunities, so I would be pleased to chat about job openings in the engineering sphere.<br><br>Send <span class='bold'>'help'</span> to know more about me.<br>");
            }, 2000);
            break;
        case "help":
